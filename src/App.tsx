    ...
    <div className="min-h-screen overflow-x-hidden bg-white text-gray-900">
      ...
      <section id="overview" className="relative py-32">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-orange-500/35 to-amber-500/35 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-orange-500/0 to-amber-500/0 rounded-full blur-3xl"></div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-20">
          ...
          <h1 className="text-6xl lg:text-8xl font-bold mb-8 leading-tight">
            ...
            <span className="block bg-gradient-to-r from-orange-500 to-amber-500 bg-clip-text text-transparent">
              <span className="text-3d-neon">Project Lab</span>
            </span>
          </h1>
          ...
          <p className="text-lg lg:text-xl mb-12 max-w-4xl mx-auto leading-relaxed drop-shadow-lg text-gray-700">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto">
            ...
            <div className="text-center backdrop-blur-sm rounded-lg p-4 border bg-white/30 border-gray-300/50">
              <div className="text-4xl font-bold bg-gradient-to-r from-orange-400 to-amber-400 bg-clip-text text-transparent mb-2">≈ 200</div>
              <div className="text-sm uppercase tracking-wider text-gray-600">Hours Project Size</div>
            </div>
          </div>
        </div>
      </section>
