      ...
      <section id="overview" className="relative py-32">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-20">
          ...
          <h1 className="text-6xl lg:text-8xl font-bold mb-8 leading-tight">
            ...
            <span className="block bg-gradient-to-r from-orange-500 via-orange-400 to-amber-400 bg-clip-text text-transparent drop-shadow-2xl filter drop-shadow-[0_0_20px_rgba(251,146,60,0.8)] drop-shadow-[0_0_40px_rgba(251,146,60,0.4)] neon-glow">
              Project Lab
            </span>
          </h1>
