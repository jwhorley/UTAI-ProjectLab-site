...
function App() {
  ...
  return (
    <div className="min-h-screen overflow-x-hidden transition-colors duration-300 bg-white text-gray-900">
      {/* Navigation */}
      <nav className="fixed top-0 w-full backdrop-blur-md border-b z-50 transition-colors duration-300 bg-white/90 border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#overview" className="hover:text-orange-400 transition-colors duration-300 text-gray-700">Overview</a>
              <a href="#process" className="hover:text-orange-400 transition-colors duration-300 text-gray-700">Process</a>
              <a href="#benefits" className="hover:text-orange-400 transition-colors duration-300 text-gray-700">Benefits</a>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-20">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            ...
            <button className="border border-gray-400 text-gray-900 bg-black/10 px-8 py-4 rounded-full font-semibold hover:border-orange-500 hover:text-orange-400 transition-all duration-300 backdrop-blur-sm">Watch Demo</button>
          </div>
